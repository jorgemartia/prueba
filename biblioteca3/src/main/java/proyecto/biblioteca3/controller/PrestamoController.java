...
public class PrestamoController {
        private String usuarioId;  // ✅ Debe ser String
    ...
    @GetMapping
    public ResponseEntity<ApiResponse<List<Prestamo>>> listar(@RequestParam String usuarioId) {
    ...
    public ResponseEntity<ApiResponse<List<Prestamo>>> obtenerPorUsuario(@PathVariable String usuarioId) {
